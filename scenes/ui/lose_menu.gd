...
@onready var restart_btn = $Panel/CenterContainer/VBoxContainer/HBoxContainer/Button
...
func _ready() -> void:
	...
	_setup_button_hover(restart_btn)
...
func _on_restart_pressed() -> void:
	# Keep time scale correct if it was paused
